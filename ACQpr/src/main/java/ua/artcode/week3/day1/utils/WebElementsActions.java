...
public class WebElementsActions {
    ...
    public void clickButton(String buttonLocator) throws IOException {
        ...
        log.info("click Button" + buttonLocator);
    }
    ...
    public String getElText(String linkLocator) throws IOException {
        String elText;
        elText = driver.findElement(ui(linkLocator)).getText();
        log.info("text" + linkLocator + elText);
        return elText;
    }
